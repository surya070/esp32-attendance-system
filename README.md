...
- **ESP32-Cam Integration** – Streams video or sends captured images to the server.  
- **Motion-Triggered Attendance** – Detects movement and automatically triggers attendance capture.  
